...
RSpec.describe Patient do
  ...
  describe '.search' do
    ...
    let(:jose) do
      create(:patient, doctors: [doctor], hospital:, name: 'José', first_name: 'Pérez', last_name: 'Castro')
    end
    let(:juan) do
      create(:patient, doctors: [doctor], hospital:, name: 'Juan', first_name: 'Sanchez', last_name: 'Ramos')
    end
    let(:juanito) do
      create(:patient, doctors: [doctor], hospital:, name: 'Juanito', first_name: 'Vasquez',
                       last_name: 'Suarez')
    end
    let(:josue) do
      create(:patient, doctors: [doctor], hospital:, name: 'Josué', first_name: 'Garcia', last_name: 'Rios')
    end
    ...
    context 'with accent' do
      it 'returns 2 items' do
        patient = create(:patient, doctors: [doctor], hospital:, name: 'Aron')
        create(:patient, doctors: [doctor], hospital:, name: 'Áron')
