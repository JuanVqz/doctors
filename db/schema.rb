...
ActiveRecord::Schema[7.1].define(version: 20_240_412_213_946) do
  ...
  create_table 'doctors_patients', id: false, force: :cascade do |t|
    ...
    t.index %w[doctor_id patient_id], name: 'index_doctors_patients_on_doctor_id_and_patient_id'
    t.index %w[patient_id doctor_id], name: 'index_doctors_patients_on_patient_id_and_doctor_id'
  end
