...
module ApplicationHelper
  ...
  def delete_button
    'text-white bg-red-600 border border-gray-300 focus:outline-none hover:bg-red-800 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-red-600 dark:text-white dark:border-red-800 dark:hover:bg-red-700 dark:hover:border-red-600 dark:focus:ring-gray-700'
  end
